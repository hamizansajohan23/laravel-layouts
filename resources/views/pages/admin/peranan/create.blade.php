...
@section('header_title', 'Tambah Peranan')
@section('header_subtitle', 'Cipta peranan baharu dengan kebenaran tertentu')
...
@section('content')
  <div class="form-page">
    ...
    <form action="{{ route('admin.peranan.store') }}" method="POST">
      @csrf

      <div class="form-card">
        <div class="form-card-header">
          <h3><i class="fa-solid fa-user-shield"></i> Maklumat Peranan</h3>
          <p>Masukkan maklumat peranan dan pilih kebenaran yang diperlukan</p>
        </div>
        ...
        <div class="form-card-body">
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-input @error('name') input-error @enderror"
              value="{{ old('name') }}" placeholder="cth: editor, moderator" required>
          ...
          <div class="form-group">
            ...
            <input type="text" name="display_name" class="form-input @error('display_name') input-error @enderror"
              value="{{ old('display_name') }}" placeholder="cth: Editor, Moderator" required>
          ...
          <div class="form-group">
            ...
            <textarea name="description" class="form-input form-textarea @error('description') input-error @enderror"
              placeholder="Penerangan ringkas tentang peranan ini">{{ old('description') }}</textarea>
            @error('description')
              <div class="form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
            @enderror
          </div>
      ...
      <div class="form-card" style="margin-top: 24px;">
            ...
            <div class="permission-section">
              ...
              <div class="permission-grid">
                @foreach ($groupPermissions as $permission)
                  <label class="permission-item" for="perm_{{ $permission->id }}">
        ...
        <div class="form-actions">
          ...
          <button type="submit" class="btn btn-primary">
            <i class="fa-solid fa-save"></i> Simpan Peranan
          </button>
        </div>
      </div>
    </form>
