...
@section('header_subtitle', 'Kemaskini maklumat permohonan')
...
<div class="form-page">
  <div class="form-sidebar">
    <div class="info-card">
      ...
      <h5>Edit Permohonan</h5>
      <p>Kemaskini maklumat permohonan anda. Permohonan hanya boleh diedit jika masih dalam semakan.</p>
    </div>
  ...
  <form action="{{ route('permohonan.update', $permohonan) }}" method="POST">
    ...
    <div class="form-card">
      <div class="form-card-header">
        <h4>Kemaskini Maklumat Permohonan</h4>
      </div>
      ...
      <div class="form-card-body">
        <div class="form-group">
          ...
          <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $permohonan->nama) }}" placeholder="Masukkan nama penuh">
          @error('nama')
        ...
        <div class="form-group">
          ...
          <input type="text" name="nokp" class="form-control @error('nokp') is-invalid @enderror" value="{{ old('nokp', $permohonan->nokp) }}" placeholder="Contoh: 880101125555" maxlength="12">
        ...
        <div class="form-group">
          ...
          <input type="email" name="emel" class="form-control @error('emel') is-invalid @enderror" value="{{ old('emel', $permohonan->emel) }}" placeholder="Contoh: nama@kpm.gov.my">
          @error('emel')
            <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <select name="bahagian_id" class="form-control @error('bahagian_id') is-invalid @enderror">
            ...
            @foreach ($bahagians as $bahagian)
              <option value="{{ $bahagian->id }}" {{ old('bahagian_id', $permohonan->bahagian_id) == $bahagian->id ? 'selected' : '' }}>
